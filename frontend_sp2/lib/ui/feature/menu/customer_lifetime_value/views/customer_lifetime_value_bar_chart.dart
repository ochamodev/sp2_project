...
class CustomerLifetimeValueBarChart extends StatelessWidget {
  final List<int> months;
  final List<double> customerValue;
  final List<double> purchaseValue;
  const CustomerLifetimeValueBarChart(
      {required this.months, required this.customerValue, required this.purchaseValue, super.key});
  ...
  List<BarChartGroupData> get barGroups => months
      .map(
        (month) => BarChartGroupData(
          ...
          barRods: [
            BarChartRodData(
                toY: customerValue[month - 1],
                color: AppColors.deepPurple,
                width: 40,
                borderRadius: const BorderRadius.all(Radius.circular(0))),
            BarChartRodData(
                toY: purchaseValue[month - 1],
