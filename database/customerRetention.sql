...
BEGIN
    ...
    -- Create tables to store data for analysis
    CREATE TABLE IF NOT EXISTS TempPrevMonthClients (
                                                        idReceptor INT,
                                                        amountGrandTotal DECIMAL(13, 2)
    );

    CREATE TABLE IF NOT EXISTS TempCurrMonthClients (
                                                        idReceptor INT,
                                                        amountGrandTotal DECIMAL(13, 2)
    );
    ...
    IF count = maxMonth THEN
        ...
        DROP TABLE IF EXISTS CancelledClients, NewClients, RetainedClients;
    ...
    -- Drop tables
    DROP TABLE IF EXISTS TempPrevMonthClients, TempCurrMonthClients, CancelledClients, NewClients, RetainedClients;
